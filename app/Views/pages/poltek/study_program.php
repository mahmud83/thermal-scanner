                    ...
                    <div class="add-form-group form-group mb-0">
                        <div class="input-group">
                            ...
                            <input id="add-form-input-name" name="name" class="add-form-input form-control"
                                   placeholder="Nama Prodi" type="text" autocomplete="off" role="presentation"
                                   required/>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="delete-form" role="form">
                <div class="modal-body mt--4">
                    ...
                    <small><b>Anda yakin ingin menghapus prodi ini?<br/>Aksi ini tidak dapat
                            dibatalkan.</b></small>
        ...
        <div class="modal-content">
            ...
            <form id="import-form" role="form">
                <div class="modal-body mt--4">
                    <div class="mb-3">
                        <small>
                            Impor data prodi dengan file CSV atau Excel.<br/>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="truncate-form" role="form">
                <div class="modal-body mt--4">
                    <small><b>Anda yakin ingin menghapus semua prodi?<br/>Aksi ini tidak dapat
                            dibatalkan.</b></small>
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <button onclick="performEditData(${meta.row})" class="dropdown-item">Edit Prodi</button>
                                <button onclick="performDeleteData(${meta.row})" class="dropdown-item">Hapus Prodi</button>
                            </div>
                        </div>
                    `;
                    }
