                    ...
                    <div class="modal-body mt--4">
                        <div id="add-form-group" class="form-group mb-0">
                            <div class="input-group">
                                ...
                                <input id="add-form-input" name="name" class="form-control" placeholder="Nama Dosen"
                                    type="text" required />
                            </div>
                        </div>
                    ...
                    <div class="modal-body mt--4">
                        ...
                        <div id="edit-form-group" class="form-group mb-0">
                            <div class="input-group">
                                ...
                                <input id="edit-form-input" name="name" class="form-control" placeholder="Nama Dosen"
                                    type="text" required />
                            </div>
                        </div>
